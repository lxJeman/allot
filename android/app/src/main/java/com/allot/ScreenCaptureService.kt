...
class ScreenCaptureService : Service() {
        ...
        serviceScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                if (frame != null) {
                    ...
                    if (result != null) {
                        Log.d(TAG, "📊 Analysis complete (${duration}ms): ${result.category} (${result.confidence})")
                ...
                if (accessibilityService != null) {
                    ...
                    handler.postDelayed({
                        ...
                        if (scrolled) {
                            ...
                            Log.w(TAG, "⚠️  Auto-scroll failed")
                        }
                        ...
                        }, 2000) // Hide 2 seconds after scroll
    ...
    fun notifyCapture(base64: String, width: Int, height: Int, timestamp: Long) {
        ...
        handler.post {
            onCaptureCallback?.invoke(base64, width, height, timestamp)
        }
    }
